...
1. An IBM Cloud account (sign up at https://cloud.ibm.com/)
2. Access to Watsonx.ai service

## Step 1: Get Your Watson API Credentials

1. **Log in to IBM Cloud**: Go to https://cloud.ibm.com/ and sign in
2. **Create or Access Watsonx.ai Project**:
...
2. **Navigate to the Compliance page**: http://localhost:3000/compliance

3. **Test the Q&A Assistant**:
   - Ask a compliance question
   - You should receive an AI-generated response from Watson

4. **Test the Permit Checker**:
...
1. Check your IBM Cloud project settings
...
- [IBM Granite Models](https://www.ibm.com/products/watsonx-ai/models)
